...
JDK 21 is managed automatically by the Gradle wrapper via [Foojay Toolchains Plugin](https://github.com/gradle/foojay-toolchains) -- no manual JDK installation required.
